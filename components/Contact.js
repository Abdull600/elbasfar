...
export default function Contact () {
    ...
    const [state, handleSubmit] = useForm("mdobrkwg");
    if (state.succeeded) {
        return <p className='text-center'>Thanks for leaving a message!</p>;
        }

    return (
        <section id='contact' className="py-20 mx-5 lg:py-[120px] overflow-hidden relative z-10">
                 ...
                 <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
                    <div className="max-w-[570px] mb-12 lg:mb-0">
                       ...
                       <p className="text-base text-body-color leading-relaxed mb-9">
                          Have a job for me or want to collaborate on a project?
                       </p>
                       <div className="flex mb-8 max-w-[370px] w-full">
                          ...
                          <div className="w-full">
                             <h4 className="font-bold text-dark text-xl mb-1">Location</h4>
                       ...
                       <div className="flex mb-8 max-w-[370px] w-full">
                          ...
                          <div className="w-full">
                             ...
                             <p className="text-base text-body-color">(+234) 81 476 223 78</p>
                          </div>
                       </div>
                       <div className="flex mb-8 max-w-[370px] w-full">
                          <div
                          ...
                          <div className="w-full">
                             ...
                             <p className="text-base text-body-color">Aabdullahib8@gmail.com</p>
                          </div>
                       </div>
                    </div>
                 </div>
